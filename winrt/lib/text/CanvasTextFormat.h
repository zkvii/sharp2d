			...
			namespace Canvas
			{
				namespace Text
				{
					...
					public:
						...
						virtual ComPtr<IDWriteTextFormat> GetRealizedTextFormatClone(
							CanvasWordWrapping overrideWordWrapping) = 0;
					...
					public:
						...
						// ComPtr<ICanvasFontSet> m_customFontSet;
...
#undef PROPERTY
						...
						virtual ComPtr<IDWriteTextFormat> GetRealizedTextFormatClone(
							CanvasWordWrapping overrideWordWrapping) override;
						...
						IFACEMETHOD(GetNativeResource)(ICanvasDevice* device, float dpi, REFIID iid,
					...
					private:
						...
						HRESULT __declspec(nothrow) PropertyPut(T value, TT* dest, FNV&& validator,
						                                        void (CanvasTextFormat::*realizer)(IDWriteTextFormat1*)
							                                        = nullptr);

						template <typename T, typename TT>
						HRESULT __declspec(nothrow) PropertyPut(T value, TT* dest,
						                                        void (CanvasTextFormat::*realizer)(IDWriteTextFormat1*)
							                                        = nullptr);
						...
						void RealizeCustomFontSet(IDWriteTextFormat1* textFormat);
            ...
            UNREFERENCED_PARAMETER(lineSpacingMode);
					...
					struct DWriteToCanvasTextDirection
					{
						...
						static DWriteToCanvasTextDirection const* Lookup(
