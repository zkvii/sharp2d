	...
	namespace Microsoft
	{
		namespace Graphics
		{
			namespace Canvas
			{
				...
				ComPtr<ID2D1StrokeStyle1> ToD2DStrokeStyle(ICanvasStrokeStyle* strokeStyle,
				...
				ComPtr<CanvasDrawingSession> CanvasDrawingSession::CreateNewMultiThread(
					ID2D1DeviceContext1* deviceContext,
					std::shared_ptr<ICanvasDrawingSessionAdapter>& drawingSessionAdapter,
					ICanvasDevice* owner,
					std::shared_ptr<bool> targetHasActiveDrawingSession,
				...
				bool DefaultInkAdapter::IsHighContrastEnabled()
				{
					if (!m_accessibilitySettings)
					{
						...
						ThrowIfFailed(GetActivationFactory(
							HStringReference(RuntimeClass_Windows_UI_ViewManagement_AccessibilitySettings).Get(),
							&activationFactory));
				...
				CanvasDrawingSession::CanvasDrawingSession(
					ID2D1DeviceContext1* deviceContext,
					const std::shared_ptr<ICanvasDrawingSessionAdapter>& adapter,
					ICanvasDevice* owner,
					std::shared_ptr<bool> targetHasActiveDrawingSession,
					D2D1_POINT_2F offset)
					...
					ICanvasImage* image)
				{
					...
					return DrawImageImpl(image, &offset, nullptr, nullptr, DefaultDrawImageOpacity(),
					                     DefaultDrawImageInterpolation(), nullptr);
				}
				...
				{
					return DrawBitmapImpl(bitmap, nullptr, &destinationRect, nullptr, DefaultDrawImageOpacity(),
					                      DefaultDrawImageInterpolation(), nullptr);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::DrawImageAtOffsetWithSourceRect(
					...
					Rect sourceRect)
				{
					return DrawImageImpl(image, &offset, nullptr, &sourceRect, DefaultDrawImageOpacity(),
					                     DefaultDrawImageInterpolation(), nullptr);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::DrawImageToRectWithSourceRect(
					...
					Rect sourceRect)
				{
					return DrawImageImpl(image, nullptr, &destinationRect, &sourceRect, DefaultDrawImageOpacity(),
					                     DefaultDrawImageInterpolation(), nullptr);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::DrawImageAtOffsetWithSourceRectAndOpacity(
					...
					float opacity)
				{
					return DrawImageImpl(image, &offset, nullptr, &sourceRectangle, opacity,
					                     DefaultDrawImageInterpolation(), nullptr);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::DrawImageToRectWithSourceRectAndOpacity(
					...
					float opacity)
				{
					return DrawImageImpl(image, nullptr, &destinationRectangle, &sourceRectangle, opacity,
					                     DefaultDrawImageInterpolation(), nullptr);
				}
				...
				IFACEMETHODIMP
				CanvasDrawingSession::DrawImageAtOffsetWithSourceRectAndOpacityAndInterpolationAndComposite(
					ICanvasImage* image,
					Vector2 offset,
					Rect sourceRectangle,
					float opacity,
				...
				IFACEMETHODIMP
				CanvasDrawingSession::DrawImageAtCoordsWithSourceRectAndOpacityAndInterpolationAndComposite(
					ICanvasImage* image,
					float x,
					float y,
					Rect sourceRectangle,
				...
				IFACEMETHODIMP
				CanvasDrawingSession::DrawImageToRectWithSourceRectAndOpacityAndInterpolationAndComposite(
					ICanvasImage* image,
					Rect destinationRectangle,
					Rect sourceRectangle,
					float opacity,
				...
				IFACEMETHODIMP
				CanvasDrawingSession::DrawImageAtOffsetWithSourceRectAndOpacityAndInterpolationAndPerspective(
					ICanvasBitmap* bitmap,
					Vector2 offset,
					Rect sourceRectangle,
					float opacity,
				...
				{
					return DrawBitmapImpl(bitmap, &offset, nullptr, &sourceRectangle, opacity, interpolation,
					                      &perspective);
				}

				IFACEMETHODIMP
				CanvasDrawingSession::DrawImageAtCoordsWithSourceRectAndOpacityAndInterpolationAndPerspective(
					ICanvasBitmap* bitmap,
					float x,
					float y,
					Rect sourceRectangle,
				...
				IFACEMETHODIMP
				CanvasDrawingSession::DrawImageToRectWithSourceRectAndOpacityAndInterpolationAndPerspective(
					ICanvasBitmap* bitmap,
					Rect destinationRectangle,
					Rect sourceRectangle,
					float opacity,
					...
					Matrix4x4 perspective)
				{
					return DrawBitmapImpl(bitmap, nullptr, &destinationRectangle, &sourceRectangle, opacity,
				...
				public:
					DrawImageWorker(ICanvasDevice* canvasDevice, ID2D1DeviceContext1* deviceContext, Vector2* offset,
					                Rect* destinationRect, Rect* sourceRect, float opacity,
					                CanvasImageInterpolation interpolation)
					...
					void DrawImage(ICanvasImage* image, CanvasComposite const* composite)
					{
						...
						else
						{
							...
							ComPtr<ID2D1Image> d2dImage = ICanvasImageInternal::GetD2DImageFromInternalOrInteropSource(
								image, m_canvasDevice, m_deviceContext);

							auto d2dInterpolationMode = static_cast<D2D1_INTERPOLATION_MODE>(m_interpolation);
							auto d2dCompositeMode = composite
							...
							if (m_offset)
								...
								DrawImageToRect(d2dImage.Get(), *m_destinationRect, d2dInterpolationMode,
								                d2dCompositeMode);
						}
					}
				...
				private:
						...
						D2D1_COMPOSITE_MODE d2dCompositeMode)
					{
						...
						m_deviceContext->DrawImage(d2dImage, &d2dOffset, GetD2DSourceRect(), d2dInterpolationMode,
						                           d2dCompositeMode);
					}
						...
						D2D1_COMPOSITE_MODE d2dCompositeMode)
					{
						...
						auto scale = Vector2{
							destinationRect.Width / sourceWidth, destinationRect.Height / sourceHeight
						};

						TemporaryTransform<ID2D1DeviceContext1> transform(m_deviceContext, offset, scale);

						auto d2dOffset = D2D1_POINT_2F{0, 0};
						m_deviceContext->DrawImage(d2dImage, &d2dOffset, &m_d2dSourceRect, d2dInterpolationMode,
						                           d2dCompositeMode);
					}
					...
					ID2D1Image* MaybeApplyOpacityEffect(ID2D1Image* d2dImage)
					{
						...
						if (auto bitmap = MaybeAs<ID2D1Bitmap>(d2dImage))
						{
							...
							//
							ThrowIfFailed(
								D2D1::SetDpiCompensatedEffectInput(m_deviceContext, opacityEffect.Get(), 0,
								                                   bitmap.Get()));
						}
						else
						{
					...
					ID2D1Image* MaybeAdjustD2DSourceRect(ID2D1Image* d2dImage)
					{
						...
						ThrowIfFailed(
							D2D1::SetDpiCompensatedEffectInput(m_deviceContext, borderEffect.Get(), 0,
							                                   d2dBitmap.Get()));
					...
					CanvasComposite const* composite)
				{
					return ExceptionBoundary([&]
					{
						...
						DrawImageWorker(GetDevice().Get(), deviceContext.Get(), offset, destinationRect, sourceRect,
						                opacity, interpolation).DrawImage(image, composite);
					});
				}
					...
					Numerics::Matrix4x4* perspective)
				{
					return ExceptionBoundary([&]
					{
						...
						DrawImageWorker(GetDevice().Get(), deviceContext.Get(), offset, destinationRect, sourceRect,
						                opacity, interpolation).DrawBitmap(bitmap, perspective);
					});
				}
				...
				static bool ArePointsInsideBitmap(ID2D1Bitmap* bitmap, D2D1_POINT_2F const& point1,
				                                  D2D1_POINT_2F const& point2, D2D1_UNIT_MODE unitMode)
				{
				...
				static bool TryGetFillOpacityMaskParameters(ID2D1Brush* opacityBrush,
				                                            ID2D1DeviceContext1* deviceContext,
				                                            D2D1_RECT_F const& destRect, ID2D1Bitmap** opacityBitmap,
					...
					ICanvasBrush* opacityBrush)
				{
					return ExceptionBoundary(
						[&]
						{
							...
							if (TryGetFillOpacityMaskParameters(d2dOpacityBrush.Get(), deviceContext.Get(), d2dRect,
							                                    &opacityBitmap, &opacitySourceRect))
							{
								// Fast path: we can use FillOpacityMask.
								deviceContext->FillOpacityMask(opacityBitmap.Get(), d2dBrush.Get(), &d2dRect,
								                               &opacitySourceRect);
							}
							else
							{
					...
					ICanvasStrokeStyle* strokeStyle)
				{
					return ExceptionBoundary(
						[&]
						{
							...
							TemporaryTransform<ID2D1Brush> brushTransform(
								d2dBrush.Get(), Vector2{-offset.X, -offset.Y}, true);
					...
					ICanvasBrush* opacityBrush)
				{
					return ExceptionBoundary(
						[&]
						{
							...
							TemporaryTransform<ID2D1Brush> opacityBrushTransform(
								d2dOpacityBrush.Get(), inverseOffset, true);
        ...
        bool highContrast)
    {
        ...
        ThrowIfFailed(m_inkD2DRenderer->Draw(
            ...
            highContrast));
				...
				IFACEMETHODIMP CanvasDrawingSession::DrawGradientMeshAtCoords(
					ICanvasGradientMesh* gradientMesh, float x, float y)
				{
					return ExceptionBoundary(
						[&]
						{
				...
				IFACEMETHODIMP CanvasDrawingSession::get_TextRenderingParameters(ICanvasTextRenderingParameters** value)
				{
					return ExceptionBoundary(
						[&]
						{
							...
							{
								auto canvasTextRenderingParams = ResourceManager::GetOrCreate<
									ICanvasTextRenderingParameters>(dwriteRenderingParams.Get());
				...
				//
				static D2D1_POINT_2F GetOffsetInCorrectUnits(ID2D1DeviceContext1* deviceContext,
				                                             D2D1_POINT_2F const& offset)
				{
				...
				//
				static void SetTransform(ID2D1DeviceContext1* deviceContext, D2D1_POINT_2F const& offset,
				...
				IFACEMETHODIMP CanvasDrawingSession::get_Transform(
					ABI::Microsoft::Graphics::Canvas::Numerics::Matrix3x2* value)
				{
					return ExceptionBoundary(
						[&]
						{
				...
				IFACEMETHODIMP CanvasDrawingSession::put_Transform(
					ABI::Microsoft::Graphics::Canvas::Numerics::Matrix3x2 value)
				{
					return ExceptionBoundary(
						[&]
				...
				IFACEMETHODIMP CanvasDrawingSession::get_EffectBufferPrecision(
					IReference<CanvasBufferPrecision>** value)
				{
					return ExceptionBoundary(
						[&]
						{
							...
							{
								auto nullable = Make<Nullable<CanvasBufferPrecision>>(
									FromD2DBufferPrecision(renderingControls.bufferPrecision));
				...
				IFACEMETHODIMP CanvasDrawingSession::ConvertDipsToPixels(
					float dips, CanvasDpiRounding dpiRounding, int* pixels)
				{
					return ExceptionBoundary(
						[&]
						{
				...
				{
					return CreateLayerImpl(opacity, nullptr, nullptr, nullptr, nullptr, CanvasLayerOptions::None,
					                       layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityBrush(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(1.0f, opacityBrush, nullptr, nullptr, nullptr, CanvasLayerOptions::None,
					                       layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityAndClipRectangle(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(opacity, nullptr, &clipRectangle, nullptr, nullptr, CanvasLayerOptions::None,
					                       layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityBrushAndClipRectangle(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(1.0f, opacityBrush, &clipRectangle, nullptr, nullptr,
					                       CanvasLayerOptions::None, layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityAndClipGeometry(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(opacity, nullptr, nullptr, clipGeometry, nullptr, CanvasLayerOptions::None,
					                       layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityBrushAndClipGeometry(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(1.0f, opacityBrush, nullptr, clipGeometry, nullptr, CanvasLayerOptions::None,
					                       layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityAndClipGeometryAndTransform(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(opacity, nullptr, nullptr, clipGeometry, &geometryTransform,
					                       CanvasLayerOptions::None, layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithOpacityBrushAndClipGeometryAndTransform(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(1.0f, opacityBrush, nullptr, clipGeometry, &geometryTransform,
					                       CanvasLayerOptions::None, layer);
				}
				...
				IFACEMETHODIMP CanvasDrawingSession::CreateLayerWithAllOptions(
					...
					ICanvasActiveLayer** layer)
				{
					return CreateLayerImpl(opacity, opacityBrush, &clipRectangle, clipGeometry, &geometryTransform,
					                       options, layer);
				}
					...
					ICanvasActiveLayer** layer)
				{
					return ExceptionBoundary(
						[&]
						{
							...
							auto d2dMatrix = geometryTransform
								                 ? *ReinterpretAs<D2D1_MATRIX_3X2_F const*>(geometryTransform)
				...
				IFACEMETHODIMP CanvasDrawingSession::DrawSvgAtPoint(ICanvasSvgDocument* svgDocument, Size viewportSize,
				                                                    Vector2 point)
				{
					return DrawSvgAtCoords(svgDocument, viewportSize, point.X, point.Y);
				}

				IFACEMETHODIMP CanvasDrawingSession::DrawSvgAtCoords(ICanvasSvgDocument* svgDocument, Size viewportSize,
				                                                     float x, float y)
				{
					return ExceptionBoundary(
						[&]
