    ...
    using namespace ABI::Windows::UI::Input::Inking;
        ...
        ComPtr<ID2D1DrawingStateBlock1> m_inkStateBlock;
				...
				public:
					...
					static ComPtr<CanvasDrawingSession> CreateNewMultiThread(
						ID2D1DeviceContext1* deviceContext,
						std::shared_ptr<ICanvasDrawingSessionAdapter>& drawingSessionAdapter,
						ICanvasDevice* owner = nullptr,
						std::shared_ptr<bool> targetHasActiveDrawingSession = nullptr,
					...
					CanvasDrawingSession(
						ID2D1DeviceContext1* deviceContext,
						const std::shared_ptr<ICanvasDrawingSessionAdapter>& drawingSessionAdapter = nullptr,
						ICanvasDevice* owner = nullptr,
						std::shared_ptr<bool> targetHasActiveDrawingSession = nullptr,
						D2D1_POINT_2F offset = D2D1_POINT_2F{0, 0});
					...
					// CanvasDrawingSession(
					//     ID2D1DeviceContext1 * deviceContext,
					//     ComPtr<ICanvasDrawingSessionAdapter> drawingSessionAdapter = nullptr,
					//     ICanvasDevice * owner = nullptr,
					//     D2D1_POINT_2F offset = D2D1_POINT_2F{ 0, 0 }) ;
					...
					static CanvasImageInterpolation DefaultDrawImageInterpolation()
					{
        ...
        IFACEMETHOD(DrawInkWithHighContrast)(IIterable<InkStroke*>* inkStrokes, boolean highContrast) override;
					...
					IFACEMETHOD(DrawSvgAtPoint)(ICanvasSvgDocument* svgDocument, Size viewportSize,
					                            Vector2 point) override;

					IFACEMETHOD(DrawSvgAtCoords)(ICanvasSvgDocument* svgDocument, Size viewportSize, float x,
					                             float y) override;
